...
<div  className='subnav1' style={{textAlign: "center"}}>
...
<Menu isOpen={menu1.isOpen}>
      ...
      <span>Micromax</span>
          ...
          <Menu isOpen={menu2.isOpen}>
            ...
            <MenuList ml="12%" onMouseEnter={menu2.onOpen} onMouseLeave={menu2.onClose}>
            <MenuItem color="gray">
                <Image
        boxSize='2rem'
        borderRadius='full'
      ...
      <span>Winter Wear</span>
          ...
          <Menu isOpen={menu3.isOpen}>
            ...
            <MenuList ml="25%" onMouseEnter={menu3.onOpen} onMouseLeave={menu3.onClose}>
            <MenuItem color="gray"  >
                <Image
        boxSize='2rem'
        borderRadius='full'
